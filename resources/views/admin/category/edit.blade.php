...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('update-category/'.$product->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="checkbox" {{ $product->popular == "1" ? 'checked':'' }} class="form-control" name="popular">
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    @if($product->image)
                        <img src="{{ asset('assets/uploads/category/'.$product->image) }}" alt="Category image">
                    @endif
                    <div class="col-md-12">
